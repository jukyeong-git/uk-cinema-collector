import type {Performance} from './types.ts';
import {load} from 'cheerio';
import {requireCondition} from './errors.ts';
const months = ['January','February','March','April','May','June','July','August','September','October','November','December'];
export function localTime(text: string) {
...
export function validLocalTime(value: unknown) {
...
export function checkedPageUrl(value: string | undefined, base?: string) {
  let url;
  requireCondition(typeof value === 'string', 'INVALID_PAGE_URL');
